...
![仪表盘](docs/screenshots/dashboard-overview.png)
...
### 管理界面
- Vue 3 管理面板：仪表盘、模型、供应商、授权、统计
- 中英文双语（`zh` / `en`）支持
- 亮色/暗色/自动主题切换
- 桌面客户端：Electrobun macOS 原生应用

| 仪表盘 | 模型管理 |
|--------|---------|
| ![仪表盘](docs/screenshots/dashboard-overview.png) | ![模型管理](docs/screenshots/models-management.png) |
