...
export function seedData() {
  ...
  const p2: ProviderWithMeta = {
    ...
    auths: [a3],
    rate_limits: [{ type: "concurrency", max: 10 }],
  ...
  const p3: ProviderWithMeta = {
    ...
    auths: [a4, a5],
    rate_limits: [{ type: "weighted_requests", max: 60, period: "minute" }],
    request_timeout_ms: 60000,
    max_retries: 3,
    enabled: true,
  ...
  const m2: ModelAliasWithMeta = {
    ...
    alias: "fast-model",
    strategy: "priority",
    models: [{ provider_id: "provider_a", model_name: "gpt-4o-mini" }],
    enabled: true,
    queue_timeout: 30000,
  ...
  const m5: ModelAliasWithMeta = {
    ...
    alias: "vision-model",
    strategy: "proportional",
    models: [{ provider_id: "provider_a", model_name: "gpt-4o" }],
    enabled: true,
    queue_timeout: 30000,
